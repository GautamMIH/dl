...
<body>
   <div class="navbar wrapper">
        ...
        <div class="navbar__menus">
            ...
            <a href="updatefelony.php" class="navbar__menus__item active">
                Felony
            </a>
   ...
   <section class="adminpanel wrapper">
        ...
        <div class="tabbox">
            ...
            <div class="cTable__relative">
                <form action="increasefelony.php" method="POST">
                <table class="cTable">
                    <thead>
                   ...
                   if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    $querynlid = "SELECT * FROM license WHERE DL_no = '$nlid' ";
                   ...
                   if (mysqli_num_rows($result) == 1) {
                    ...
                    if (mysqli_num_rows($result) == 1){
                        ...
                        <td><input type='text' id='Felony' value=' $felony' readonly ></td>
                        <td><input type='text' id='Category' value=' $category' readonly ></td> 
                        <td><button class='cBtn cBtn--blue' type='submit'><span>Update</span></button></td></tr>";

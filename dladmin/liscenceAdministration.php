...
<body>
   <div class="navbar wrapper">
        ...
        <div class="navbar__menus">
            ...
            <a href="liscenceAdministration.php" class="navbar__menus__item active">
                ...
                <table class="cTable liscenceAdministration__table">
                    <thead>
                        <tr>
                            ...
                            <td rowspan="2">Written Exam Date</td>
                            <td rowspan="2">Written Exam Status</td>
                    ...
                    <tbody>
                        <tr>
                            ...
                            if($we == ""){
                                ...
                                $displayStylewe = 'style="display: none;"';
                                $displayStyleft = 'style="display: none;"';
                                $displayStylefts = 'style="display: none;"';
                                $displayStylest = 'style="display: none;"';
                                $displayStylests = 'style="display: none;"';
                                $displayStylett = 'style="display: none;"';
                                $displayStyletts = 'style="display: none;"';
                            ...
                            ?>
                            <td><input type="date" name ="wedate"></td>
                            <td <?php echo $displayStylewe?>><select name="writtenexamstatus" id="writtenexamstatus" <?php echo $displayStyle?>>
                                    <option value="" >NULL<option>
                                    <option value="1">passed</option>
                                    <option value="0">fail</option>
                                </select></td>
                            <td <?php echo $displayStyleft?>><input type="date" name = "firsttrialdate"></td>
                            <td class="fail" <?php echo $displayStylefts?>> 
                                <select name="firsttrialexamstatus" id="firsttrialexamstatus" >
                                    <option value="" >NULL<option>
                                    <option value="passed">passed</option>
                                    <option value="fail"  >fail</option>
                                </select>
                            </td>
                            <td <?php echo $displayStylest?>><input type="date" name="secondtrialdate" ></td>
                            <td class="fail" <?php echo $displayStylests?>>
                                <select name="secondtrialexamstatus" id="secondtrialexamstatus" >
                                    <option value="" >NULL<option>
                                    <option value="passed">passed</option>
                                    <option value="fail"  >fail</option>
                                </select>
                            </td>
                            <td <?php echo $displayStylett?>><input type="date" name="thirdtrialdate"></td>
                            <td <?php echo $displayStyletts?>>
                                <select name="thirdtrialexamstatus" id="thirdtrialexamstatus" >
                                    <option value="" >NULL<option>
                                    <option value="passed">passed</option>
                                    <option value="fail"  >fail</option>
                                </select>
